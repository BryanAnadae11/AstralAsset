...
def home(request):
	return render(request, 'AstralAssetsApp/index.html')
...
def card(request):
	if request.method == 'GET':
		...
		if form.is_valid():
			...
			print(name)
		try:
			send_mail("Astral Asset Card Request", "User with name {} and email {} has requested for card to this address: {}".format(name, email, address),email, ['info@astralassets.org'])
			print('Request Sent')
	...
	context={'form':form}
	return render(request, 'AstralAssetsApp/card.html', context)

def stats(request):
	return render(request, 'AstralAssetsApp/stats.html')

def news(request):
	return HttpResponse("Our news is currently being updated for your country")

def legal(request):
	return render(request, 'AstralAssetsApp/legal.html')

def affiliates(request):
	return render(request, 'AstralAssetsApp/affiliates.html')

def oilandgas(request):
	return render(request, 'AstralAssetsApp/oilandgas.html')

def plan(request):
	return render(request, 'AstralAssetsApp/plan.html')

def otherpayment(request):
    return render(request, 'AstralAssetsApp/otherpayment.html')


def about(request):
	return render(request, 'AstralAssetsApp/company.html')


def career(request):
	return render(request, 'AstralAssetsApp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('AstralAssetsApp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'AstralAssetsApp/signin.html')


def privacy(request):
	return render(request, 'AstralAssetsApp/privacy.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'AstralAssetsApp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('AstralAssetsApp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('AstralAssetsApp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
			'Welcome to Astral Assets',
			plain_message,
			settings.EMAIL_HOST_USER,
			[email],
		...
		second_template= render_to_string('AstralAssetsApp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		second_plain_message= strip_tags(second_template)
		second_email_message= EmailMultiAlternatives(
			"Stay updated and discover more with Astral Assets!",
		...
		try:
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'AstralAssetsApp/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'AstralAssetsApp/dashboard.html', context)
...
def admindashboard(request):
	...
	return render(request, 'AstralAssetsApp/adminpage.html', context)


def terms(request):
	return render(request, 'AstralAssetsApp/terms.html')


def realestate(request):
	return render(request, 'AstralAssetsApp/realestate.html')


def crypto(request):
	return render(request, 'AstralAssetsApp/crypto.html')


def forex(request):
	return render(request, 'AstralAssetsApp/forex.html')


def nft(request):
	return render(request, 'AstralAssetsApp/nft.html')


def contact(request):
	return render(request, 'AstralAssetsApp/contact.html')


def stocks(request):
	return render(request, 'AstralAssetsApp/stocks.html')


def agriculture(request):
	return render(request, 'AstralAssetsApp/agriculture.html')


def gold(request):
	return render(request, 'AstralAssetsApp/gold.html')


def retirement(request):
	return render(request, 'AstralAssetsApp/retirement.html')
...
def packageOptions(request):
	return render(request, 'AstralAssetsApp/deposit.html')
...
def agriculturalDeposit(request):
	...
	context= {}
	return render(request, 'AstralAssetsApp/agriculturalDeposit.html', context)
...
def stocksDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'AstralAssetsApp/StocksDepositForm.html', context)
...
def cryptoDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'AstralAssetsApp/cryptoDepositForm.html', context)
...
def oilandgasDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'AstralAssetsApp/oilandgasDeposit.html')
...
def goldDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'AstralAssetsApp/goldDeposit.html', context)
...
def forexDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'AstralAssetsApp/forexDeposit.html', context)
...
def retirementDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'AstralAssetsApp/retirementdepositForm.html', context)
...
def realestateDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'AstralAssetsApp/realestateDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'AstralAssetsApp/PortfolioDepositForm.html', context)
...
def deposit(request):
	if request.method=='GET':
		...
		if price_amount and pay_currency:
			...
			template= render_to_string('AstralAssetsApp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
			except BadHeaderError:
				pass
			...
			if str(pay_currency) == 'xrp':
				return redirect(xrp_deposit)

			if str(pay_currency) == 'USDC':
				return redirect(usdc_deposit)
...
def btc_deposit(request):
	...
	if request.method == 'POST':
		try:
			send_mail(client_name, "A client with username: {} has made a deposit of ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
		except:
			pass
	...
	return render(request, 'AstralAssetsApp/btc_deposit.html', context)

@login_required(login_url='signin')
def xrp_deposit(request):
	client= request.user.client
	client_name= request.user.username
	pay_wallet= 'xrp'
	try:
		...
		wallet_address_query= Wallet.objects.all()
		for i in wallet_address_query:
			wallet_address = i.xrp
	except:
		return HttpResponse('XRP wallet address not available at the moment. Try again later.')
	if request.method == 'POST':
		try:
			send_mail(client_name, "A client with username: {} has made a deposit of ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
		except:
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'AstralAssetsApp/xrp_deposit.html', context)

@login_required(login_url='signin')
def usdc_deposit(request):
	client= request.user.client
	client_name= request.user.username
	pay_wallet= 'USDC'
	try:
		...
		wallet_address_query= Wallet.objects.all()
		for i in wallet_address_query:
			wallet_address = i.usdc
	except:
		return HttpResponse('USDC wallet address not available at the moment. Try again later.')
	if request.method == 'POST':
		try:
			send_mail(client_name, "A client with username: {} has made a deposit of ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
		except:
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'AstralAssetsApp/usdc_deposit.html', context)
...
def usdt_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'AstralAssetsApp/usdt_deposit.html', context)
...
def ltc_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'AstralAssetsApp/ltc_deposit.html', context)
...
def doge_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'AstralAssetsApp/doge_deposit.html', context)
...
def eth_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'AstralAssetsApp/eth_deposit.html', context)
...
def trx_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'AstralAssetsApp/trx_deposit.html', context)
	...
	if request.method == 'GET':
		...
		if price_amount and pay_currency:
			...
			payload=json.dumps({
				...
				"success_url": "https://www.AstralAssets.org/dashboard",
				#our success url will direct us to the get_payment_status view for balance top ups
				"cancel_url": "https://www.AstralAssets.org/dashboard"
			})
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
	...
	context={}
	return render(request, 'AstralAssetsApp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'AstralAssetsApp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'AstralAssetsApp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'AstralAssetsApp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'AstralAssetsApp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'AstralAssetsApp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'AstralAssetsApp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'AstralAssetsApp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('AstralAssetsApp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('AstralAssetsApp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'AstralAssetsApp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('AstralAssetsApp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'AstralAssetsApp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'AstralAssetsApp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('AstralAssetsApp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('AstralAssetsApp/debitMail.html', {'name':client_username,
					...
					try:
						pass
						send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
					except BadHeaderError:
						pass
						return HttpResponse('Something went wrong, please try again later')
	...
	context= {}
	return render(request, 'AstralAssetsApp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'AstralAssetsApp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('AstralAssetsApp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('AstralAssetsApp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
			...
			emailmessage.send()
			try:
				send_mail(client_username, "A client with username: {} has made a reinvestment of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@astralassets.org'])
			except BadHeaderError:
				pass
	...
	return render(request, 'AstralAssetsApp/reinvest.html', context)
...
def loan(request):
	if request.method =='POST':
		...
		amount= request.POST.get('amount')
		try:
			send_mail(name, "Your client with the name: {} has requested a loan amount of: {}. Their email is {} and phone number is {}".format(name, amount,email, phone),email, ['info@astralassets.org'])
	...
	return render(request, 'AstralAssetsApp/loan.html')
...
def portfolio(request):
	...
	return render(request, 'AstralAssetsApp/portfolio.html', context)